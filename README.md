# [Django Dashboard](https://appseed.us/admin-dashboards/django?ref=gh) Tabler

[Admin dashboard](https://appseed.us/admin-dashboards) generated by AppSeed in **Django** Framework.

Tabler is a open-source admin template crafted by Codecalm agency. It comes with the basic components and set of pre-built pages required to lay the foundation for any application - Design provided by Codecalm.
...
---
[Django Dashboard](https://appseed.us/admin-dashboards/django?ref=gh) Tabler - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
